...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (empty($columnExists)) {
            ...
            DB::statement("ALTER TABLE users ADD COLUMN location POINT NULL AFTER longitude");
            ...
            // Step 3: Set sentinel value POINT(0 0) for users without coordinates
            DB::statement("
                UPDATE users 
            ...
            $columnInfo = DB::select("SHOW COLUMNS FROM users WHERE Field = 'location'");
