...
<head>
    ...
    <title>Edit Healthcare Plan - MMHC Admin</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    <h1 class="text-2xl font-bold text-gray-800">
                        ...
                        Edit Healthcare Plan: {{ $healthcarePlan->name }}
                    </h1>
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form method="POST" action="{{ route('admin.page-content.plans.update', $healthcarePlan) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="description" name="description" value="{{ old('description', $healthcarePlan->description) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                        <div>
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price', $healthcarePlan->price) }}" step="0.01" min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                        ...
                        <div>
                            ...
                            <select id="currency" name="currency" 
                                ...
                                <option value="₹" {{ old('currency', $healthcarePlan->currency) == '₹' ? 'selected' : '' }}>₹ (Rupee)</option>
                                <option value="$" {{ old('currency', $healthcarePlan->currency) == '$' ? 'selected' : '' }}>$ (Dollar)</option>
                                <option value="€" {{ old('currency', $healthcarePlan->currency) == '€' ? 'selected' : '' }}>€ (Euro)</option>
                            </select>
                        </div>
                        
                        <div>
                            <label for="duration_text" class="block text-sm font-medium text-gray-700 mb-2">Duration Text *</label>
                            <input type="text" id="duration_text" name="duration_text" value="{{ old('duration_text', $healthcarePlan->duration_text) }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <select id="color_theme" name="color_theme" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                <option value="blue" {{ old('color_theme', $healthcarePlan->color_theme) == 'blue' ? 'selected' : '' }}>Blue</option>
                                <option value="green" {{ old('color_theme', $healthcarePlan->color_theme) == 'green' ? 'selected' : '' }}>Green</option>
                                <option value="purple" {{ old('color_theme', $healthcarePlan->color_theme) == 'purple' ? 'selected' : '' }}>Purple</option>
                                <option value="orange" {{ old('color_theme', $healthcarePlan->color_theme) == 'orange' ? 'selected' : '' }}>Orange</option>
                                <option value="red" {{ old('color_theme', $healthcarePlan->color_theme) == 'red' ? 'selected' : '' }}>Red</option>
                                <option value="indigo" {{ old('color_theme', $healthcarePlan->color_theme) == 'indigo' ? 'selected' : '' }}>Indigo</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div id="features-container">
                        @if(old('features'))
                            ...
                            @endforeach
                        @else
                            @foreach($healthcarePlan->features as $index => $feature)
                                <div class="feature-input flex items-center gap-3 mb-3">
                                    <input type="text" name="features[]" value="{{ $feature }}" 
                                           class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           placeholder="Enter a feature">
                ...
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $healthcarePlan->sort_order) }}" min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                   placeholder="0">
                    ...
                    <div class="mt-6">
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_popular" value="1" {{ old('is_popular', $healthcarePlan->is_popular) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2 text-sm text-gray-700">Mark as Popular Plan</span>
                            </label>
                            
                            <label class="flex items-center">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $healthcarePlan->is_active) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
