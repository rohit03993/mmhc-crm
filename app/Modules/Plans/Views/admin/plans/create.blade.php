...
<div class="container-fluid px-3 py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <h4 class="page-title mb-0 mt-2">Create New Plan</h4>
        </div>
    </div>

    <div class="row">
        <div class="col-12 col-lg-8">
            <form action="{{ route('admin.plans.store') }}" method="POST" onsubmit="preparePaymentOptions()">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="monthly_price" id="monthly_price" class="form-control" step="0.01" min="0" value="{{ old('monthly_price') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="members_included" id="members_included" class="form-control" min="1" value="{{ old('members_included', 1) }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="duration_days">Duration (Days) *</label>
                                    <input type="number" name="duration_days" id="duration_days" class="form-control" min="1" value="{{ old('duration_days', 365) }}" required>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="icon_class" id="icon_class" class="form-control" placeholder="fa-heartbeat" value="{{ old('icon_class') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="color_theme" id="color_theme" class="form-control">
                                        <option value="blue" {{ old('color_theme', 'blue') == 'blue' ? 'selected' : '' }}>Blue</option>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="popular_label" id="popular_label" class="form-control" placeholder="Most Popular" value="{{ old('popular_label') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="button_text" id="button_text" class="form-control" value="{{ old('button_text', 'Get Started') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                    ...
                    <div class="card-body">
                        <div id="payment-options-container">
                            @php
                                ...
                                $oldPaymentOptions = old('payment_options', []);
                            @endphp
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input payment-option-enabled" 
                                                   ...
                                                   value="1" 
                                                   {{ isset($oldPaymentOptions[$frequency]) ? 'checked' : '' }}
