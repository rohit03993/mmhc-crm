...
@section('title', 'Edit Institution - Academics')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            ...
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" {{ old('is_active', $institution->is_active) ? 'checked' : '' }}>
