...
@section('page-title', 'Add topic resource')
...
<div class="container-fluid py-3">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('academics.topics.resources.store', $topic) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @csrf
                <div class="col-12">
                ...
                <div class="col-12">
                    ...
                    <select name="resource_type" id="resource_type" class="form-select @error('resource_type') is-invalid @enderror" required>
                        <option value="{{ \App\Modules\Academics\Models\TopicResource::TYPE_VIDEO_LINK }}" @selected(old('resource_type') === \App\Modules\Academics\Models\TopicResource::TYPE_VIDEO_LINK)>Video link</option>
                        <option value="{{ \App\Modules\Academics\Models\TopicResource::TYPE_FILE }}" @selected(old('resource_type') === \App\Modules\Academics\Models\TopicResource::TYPE_FILE)>File (PDF, etc.)</option>
                        <option value="{{ \App\Modules\Academics\Models\TopicResource::TYPE_CHECKLIST }}" @selected(old('resource_type') === \App\Modules\Academics\Models\TopicResource::TYPE_CHECKLIST)>Checklist file</option>
                    </select>
                ...
                <div class="col-12 d-none" id="wrap-file">
